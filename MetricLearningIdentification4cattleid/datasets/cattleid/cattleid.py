...
class cattleid(data.Dataset):
	...
	def printStats(self):
		print("Loaded the cattleid dataset_____________________________")
	...
	def __retrievePositive(self, category, filepath):
		...
		# tmp_list = possible_list
		# tmp_list.remove(filepath)
		# img_path = random.choice(tmp_list)
		# while True:
		# 	possible_list.remove(filepath)
		# 	img_path = random.choice(possible_list)
		# 	possible_list.append(filepath)
